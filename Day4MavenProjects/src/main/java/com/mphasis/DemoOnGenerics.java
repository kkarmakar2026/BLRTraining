...
//		Pair<Integer,Student> p4 = new Pair<Integer, Student>(null, s);
//				System.out.println(p4);
//				System.out.println(p4.getValue());
		
		
//		 Order<String> o1 = new Order<>("Laptop");
//	        Order<String> o2 = new Order<>("Mobile");
//	        System.out.println(o1);  // Order contains: Laptop
//	        System.out.println(o2);  // Order contains: Mobile
//
//	        Item item = new Item(12, "laptop", 50000);
//	        Order<Item> o3 = new Order<>(item);
//	        System.out.println(o3); 
		        ...
		        Integer nums[] = {4, 5, 6, 7, 8, 9, 0};   // use Integer[], not int[]
		        String strs[] = {"str", "str2", "str3", "str4"};

		        ArrayPrinter<Integer> ap1 = new ArrayPrinter<>(nums);
		        ap1.printArray();   // Output: 4 5 6 7 8 9 0

		        ArrayPrinter<String> ap2 = new ArrayPrinter<>(strs);
		        ap2.printArray();   // Output: str str2 str3 str4
		    }
